...
export default function Scanner({log}) {
  ...
  const historic = ()  => {
    axios.post(`https://61d458748df81200178a8c45.mockapi.io/api/user/1/historic`,{ 
      "name": name,
      "lactose": nam,
      "acucar": nameAcucar,
              ...
              <View  >
                ...
                <View style={{flexDirection:'row'}}>
                  <View style={styles.cardInfo}>
                    ...
                    <Image source={imageLactose} style={styles.imgCardinfo}/>
                  ...
                  <View style={[styles.cardInfo, {left:5}]}>
                    ...
                    <Image source={imageSugar}/>
                    <Text style={{left:'40%', bottom:10, fontWeight: 'bold'}}>{textSugar}</Text>
                  </View>
                </View>
                ...
                <View style={[styles.cardInfo, {width:325,}]}>
                  ...
                  <Text style={{left:'42%', bottom:10, fontWeight: 'bold'}}>{textAnimal}</Text>
                </View>
